    ...
    <div className="container py-16 md:py-20" id="contact">
      ...
      <form className="mx-auto w-full pt-10 sm:w-3/4">
        <div className="flex flex-col md:flex-row">
          <input
            ...
            placeholder="Name (ex: John Mathew)"
            type="text"
            id="name"
          />
          <input
            className="mt-6 w-full rounded border-grey-50 px-4 py-3 font-body text-black md:mt-0 md:ml-3 md:w-1/2 lg:ml-5"
            placeholder="Email (ex: you@example.com)"
            type="text"
            id="email"
          />
        </div>
        <textarea
          ...
          rows="10"
        ></textarea>
        <button className="mt-6 flex items-center justify-center rounded bg-[#0078AA] px-8 py-3 font-header text-lg font-bold uppercase text-white hover:bg-grey-20">
          Send
      ...
      <div className="flex flex-col pt-16 lg:flex-row">
        <div className="w-full border-l-2 border-t-2 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3">
          ...
          <p className="pt-2 text-left font-body font-bold text-[#0078AA] lg:text-lg">
            (+92) 310-348-7737
          </p>
        </div>
        ...
        <div className="w-full border-l-2 border-t-0 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3 lg:border-l-0 lg:border-t-2">
          ...
          <p className="pt-2 text-left font-body font-bold text-[#0078AA] lg:text-lg">
            Block-H North Nazimabad, Karachi, Pakistan
          </p>
        </div>
      </div>
    </div>
