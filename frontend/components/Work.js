  ...
  return (
    <div className="container py-16  md:py-20" id="work">
      ...
      <div className="relative mx-auto  flex w-full flex-col lg:w-2/3">
        <ol className="relative border-l border-gray-200 dark:border-gray-700 my-20">
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-[#0078AA]"></div>
